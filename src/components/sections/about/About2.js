...
const About = () => {
  const aboutContent = {
    ...
    title: "Leading Provider of AI & Automation Solutions",
    description: "We specialize in transforming businesses through cutting-edge AI technology and intelligent automation. Our solutions help companies reduce costs, improve efficiency, and deliver exceptional customer experiences.",
    features: [
      {
        icon: "bi-robot",
        title: "AI-Powered Solutions",
        text: "Custom chatbots and automation tools designed for your business needs"
      },
      {
        icon: "bi-graph-up",
        title: "Data-Driven Results",
        text: "Leverage predictive analytics and machine learning for better decisions"
      },
      {
          ...
          >
            <div className="about__inner">
                ...
                <div className="section__title__heading">
                  <h3>
                    ...
                    <span className="text__gradient">
                      TRANSFORMING BUSINESSES SINCE 1998
                    </span>
                  </h3>
                </div>
                <div className="section__title__text">
                  <p>
                    Revolutionizing industries with innovative solutions in AI,
                    business consulting, and financial empowerment.
                  </p>
                </div>
              </div>
              ...
              <div className="about__text__2">
                <p>
                  Our mission is to empower entrepreneurs and businesses with
                  cutting-edge solutions that drive growth, streamline
                  operations, and maximize potential.
                </p>
              </div>
              <div className="about__text__3">
                <p>
                  With expertise in AI, custom app development, marketing
                  automation, federal certifications, and more, we ensure every
                  client achieves unparalleled success.
                </p>
              </div>
