...
const About5 = ({ type, desc, title, img }) => {
  return (
    <div
      className={`about about__business__solution position-relative sp_bottom_140 ${
        type === 3 ? "" : "sp_top_140 "
      }`}
            ...
            <div className="about__img__wrapper position-relative" data-tilt>
              ...
              <div className="section__strock__line__animation">
                <Image
                  ...
                  alt="Small Decorative Element 1"
                />
                <Image
                  className="ssla__animation ssl__img__2"
                  src={aboutSmallImage2}
                  alt="Small Decorative Element 2"
                />
              </div>
            </div>
          </div>
          ...
          >
            <div className="about__inner">
              <div className="section__title section__title--2 sp_bottom_30">
                  ...
                  <h3>
                    {title ? (
                      ...
                      <>
                        ...
                        <span className="text__gradient">RJ Business Solutions</span>{" "}
                      </>
                    )}
                  </h3>
                </div>
                ...
                <div className="section__title__text">
                  <p>
                    {desc
                      ? desc
                      : "RJ Business Solutions specializes in delivering comprehensive business strategies, technology integration, and operational excellence to drive growth and success for our clients."}
                  </p>
                </div>
              </div>
              ...
              {type === 2 || type === 3 ? (
                <>
                  ...
                  <div className="about__text__2">
                    <p>
                      Our mission is to provide innovative, tailored solutions
                      that enable businesses to thrive in competitive markets.
                    </p>
                  </div>
                  <div className="about__text__3">
                    <p>
                      Our vision is to be the leading consultancy firm known for
                      creating impactful strategies and fostering long-term success.
                    </p>
                  </div>
                </>
              ) : (
              ...
              <div className="about__button">
                <ButtonPrimary text={"LEARN MORE ABOUT US"} path={"/about"} />
              </div>
            </div>
          </div>
        </div>
