          ...
          >
            ...
            >
              <Image
                ...
                src={aboutImage2}
                alt="About RJ Business Solutions"
                placeholder="blur"
              />
            ...
            <div className="about__inner about__inner--2">
              <div className="section__title section__title--2 sp_bottom_30">
                <div className="section__title__button">
                  <span className="text__gradient">About RJ Business Solutions</span>
                </div>
                <div className="section__title__heading">
                  <h3>
                    EMPOWERING BUSINESSES WITH 29 YEARS OF EXPERTISE AND INNOVATION.
                  </h3>
                </div>
              </div>
              ...
              <div className="about__vision__wrapper">
                <div className="about__number">
                  <div className="about__number__inner">
                    <span>29</span>
                    <p>Years of Transforming Businesses</p>
                ...
                <div className="about__text__wrapper">
                  ...
                  <div className="about__text__2">
                    <p>
                      At RJ Business Solutions, our mission is to deliver
                      innovative solutions that empower entrepreneurs and businesses
                      across industries.{" "}
                      <Link href="/services">
                        Explore our comprehensive services
                      </Link>{" "}
                      to see how we can transform your vision into reality.
                    </p>
                  </div>
