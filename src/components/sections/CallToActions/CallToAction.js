  ...
  return (
    <div className="cta__area sp_top_120 sp_bottom_330 gradient__bg position-relative">
              ...
              >
                ...
                <div className="section__title__heading">
                  <h3>
                    {title
                      ? title
                      : "READY TO TRANSFORM YOUR BUSINESS WITH RJ BUSINESS SOLUTIONS?"}
                  </h3>
                </div>
      ...
      <div className="cta__icon">
        <Image className="cta__img__1 ssla__animation" src={ctaImage1} alt="Icon 1" />
        <Image className="cta__img__2 ssla__animation" src={ctaImage2} alt="Icon 2" />
        <Image className="cta__img__3 ssla__animation" src={ctaImage3} alt="Icon 3" />
        <Image className="cta__img__4 ssla__animation" src={ctaImage4} alt="Icon 4" />
      </div>
    </div>
  );
};
